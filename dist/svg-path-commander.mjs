...
}, oe = (e) => D(e) || e === 43 || e === 45 || e === 46, ce = (e) => (e | 32) === 97, zt = (e) => {
...
const ue = {
  ...
  is2D: !0,
  isIdentity: !0
}, Dt = (e) => (e instanceof Float64Array || e instanceof Float32Array || Array.isArray(e) && e.every((t) => typeof t == "number")) && [6, 16].some((t) => e.length === t), Zt = (e) => e instanceof DOMMatrix || e instanceof v || typeof e == "object" && Object.keys(ue).every((t) => e && t in e), G = (e) => {
...
e.every(([t]) => t === t.toUpperCase()), Q = (e) => {
  ...
  return "TQ".includes(n) || (t.qx = null, t.qy = null), n === "M" ? (t.x = s, t.y = i, e) : n === "A" ? (o = [a, l, ...r], ["C", ...Pt(...o)]) : n === "Q" ? (t.qx = s, t.qy = i, o = [a, l, ...r], ["C", ...Me(...o)]) : n === "L" ? ["C", ...St(a, l, s, i)] : n === "Z" ? ["C", ...St(a, l, c, m)] : e;
}, ct = (e) => {
  if (Ut(e))
    return [...e];
  const t = z(e), n = { ...ut }, r = [];
  ...
  return t;
}, Ae = (e, t, n, r, s, i, o, a) => 3 * ((a - t) * (n + s) - (o - e) * (r + i) + r * (e - s) - n * (t - i) + a * (s + e / 3) - o * (i + t / 3)) / 20, Kt = (e) => {
  let t = 0, n = 0, r = 0;
  return ct(e).map((s) => {
    switch (s[0]) {
      case "M":
...
}, X = (e) => ft(e).length, Ne = (e) => Kt(ct(e)) >= 0, V = (e, t) => ft(e, t).point, Ct = (e, t) => {
  const n = Z(e);
...
}, we = (e, t) => yt(e, t).closest, ve = (e, t) => yt(e, t).segment, Pe = (e, t) => Ct(e, t).segment, Ce = (e, t) => {
...
e.slice(1).every(([t]) => t === t.toLowerCase()), lt = {
  ...
  let m = [];
  return a === "circle" ? m = ke(c) : a === "ellipse" ? m = $e(c) : ["polyline", "polygon"].includes(a) ? m = Le(c) : a === "rect" ? m = Se(c) : a === "line" ? m = Te(c) : ["glyph", "path"].includes(a) && (m = Z(i ? e.getAttribute("d") || "" : e.d || "")), _(m) && m.length ? m : !1;
}, at = (e, t) => {
  let { round: n } = mt;
  if (t === "off" || n === "off")
    return [...e];
...
N(w, "CSSMatrix", v), N(w, "getPathBBox", $t), N(w, "getPathArea", Kt), N(w, "getTotalLength", X), N(w, "getDrawDirection", Ne), N(w, "getPointAtLength", V), N(w, "pathLengthFactory", ft), N(w, "getPropertiesAtLength", Ct), N(w, "getPropertiesAtPoint", yt), N(w, "polygonLength", ae), N(w, "polygonArea", le), N(w, "getClosestPoint", we), N(w, "getSegmentOfPoint", ve), N(w, "getSegmentAtLength", Pe), N(w, "isPointInStroke", Ce), N(w, "isValidPath", Vt), N(w, "isPathArray", _), N(w, "isAbsoluteArray", wt), N(w, "isRelativeArray", _t), N(w, "isCurveArray", Ut), N(w, "isNormalizedArray", vt), N(w, "shapeToPath", qe), N(w, "shapeToPathArray", Wt), N(w, "parsePathString", Z), N(w, "roundPath", at), N(w, "splitPath", qt), N(w, "splitCubic", ze), N(w, "optimizePath", Ot), N(w, "reverseCurve", Ee), N(w, "reversePath", it), N(w, "normalizePath", z), N(w, "transformPath", jt), N(w, "pathToAbsolute", Q), N(w, "pathToRelative", Nt), N(w, "pathToCurve", ct), N(w, "pathToString", At), N(w, "arcToCubic", Pt), N(w, "getSVGMatrix", Gt);
export {
  w as default
};
